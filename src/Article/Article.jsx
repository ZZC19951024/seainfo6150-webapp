...
const Article = () => {
  ...
  <body>
	...
	<section class = "Intro">
      <h4>The Statue of Liberty's original torch is getting a new home.</h4>
	 ...
	 <section class = "history">
	  ...
	  <ul>
		<li>Give me your tired, your poor</li>
		<li>Your huddled masses yearning to breathe free</li>
	  </ul>
